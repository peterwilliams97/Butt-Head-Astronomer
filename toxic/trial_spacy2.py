...
# clf=0.9837   6: get_clf1 ClfSpacy(batch_size=150, dropout=0.5, epochs=40, frozen=True, learn_rate=0.001, lstm_type=2, max_length=100, n_examples=-1, n_hidden=128)
# clf=0.9815   2: get_clf0 ClfSpacy(batch_size=150, dropout=0.5, epochs=40, frozen=True, learn_rate=0.001, lstm_type=2, max_length=100, n_examples=-1, n_hidden=64)
# clf=0.9804   3: get_clf0 ClfSpacy(batch_size=150, dropout=0.5, epochs=40, frozen=True, learn_rate=0.001, lstm_type=1, max_length=100, n_examples=-1, n_hidden=64)
# clf=0.9741   4: get_clf1 ClfSpacy(batch_size=150, dropout=0.5, epochs=40, frozen=True, learn_rate=0.001, lstm_type=4, max_length=100, n_examples=-1, n_hidden=128)
# clf=0.9733   1: get_clf0 ClfSpacy(batch_size=150, dropout=0.5, epochs=40, frozen=True, learn_rate=0.001, lstm_type=3, max_length=100, n_examples=-1, n_hidden=64)
# clf=0.9721   0: get_clf0 ClfSpacy(batch_size=150, dropout=0.5, epochs=40, frozen=True, learn_rate=0.001, lstm_type=4, max_length=100, n_examples=-1, n_hidden=64)
# clf=0.9708   5: get_clf1 ClfSpacy(batch_size=150, dropout=0.5, epochs=40, frozen=True, learn_rate=0.001, lstm_type=3, max_length=100, n_examples=-1, n_hidden=128)
