...
submission_name = 'v_trial_vector_007'
epochs = 40
random_seed = 60017
set_n_samples(20000)
...
for lstm_type in [6, 9]:
    for max_length in [50, 150]:  # [50, 75, 100, 150]:
        for max_features in [20000, 40000]:  # [20000, 25000, 30000, 40000]:
