...
lstm_path = join(SUBMISSION_DIR, 'gpu5/spacy_lstmx_90.ALL.LINEAR.csv')
nb_path = join(SUBMISSION_DIR, 'tfidf_nb.csv')
ensemble_path = join(SUBMISSION_DIR, 'ensemble_nb_spacy_lstmx_90.ALL.LINEAR.csv')
...
"""
    submission scored 0.9805, which is not an improvement of your best score. Keep trying!

    Worse than LSTM NB ensemble
