...
# auc=0.9849   2: get_clf ClfGru(batch_size=32, dropout=0.5, epochs=40, max_features=30000, maxlen=100, n_hidden=256, validate=True)
# auc=0.9842   1: get_clf ClfGru(batch_size=150, dropout=0.2, epochs=40, max_features=70000, maxlen=150, n_hidden=256, validate=True)
# auc=0.9834   0: get_clf ClfGru(batch_size=32, dropout=0.2, epochs=40, max_features=30000, maxlen=100, n_hidden=80, validate=True)
...
submission.to_csv('submission_gr_fasttext4.csv', index=False)
