...
zpolarity = {0: 'zero', 1: 'one', 2: 'two', 3: 'three', 4: 'four', 5: 'five', 6: 'six', 7: 'seven',
...
def polarity_func(r):
    return (str(r['comment_text']) + ' polarity' +
            zsign[np.sign(r['polarity'])] +
            zpolarity[np.abs(r['polarity'])])


train['comment_text'] = train.apply(polarity_func, axis=1)
test['comment_text'] = test.apply(polarity_func, axis=1)
