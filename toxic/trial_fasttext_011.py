...
# auc=0.9882  35: get_clf ClfVector(batch_size=300, do_spacy=False, dropout=0.2, epochs=40, epochs2=40, learn_rate=0.002, learn_rate_unfrozen=0.002, lstm_type=13, max_features=50000, max_length=100,
