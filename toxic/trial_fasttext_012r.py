...
submission_name = 'v_trial_fasttest_012_zero'
epochs = 40
random_seed = 60020
set_n_samples(20000)
...
params_list = []
for lstm_type in [13]:
    for max_length in [30, 50, 75, 100]:  # [50, 75, 100, 150]:
        for max_features in [50000, 60000, 70000]:  # [20000, 25000, 30000, 40000]:
            for n_hidden in [120]: # , 150, 200, 250]:
